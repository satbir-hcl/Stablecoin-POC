...
- [Issues](https://github.com/hashgraph/fx-processor/issues)
...
[GitHub issues](https://github.com/hashgraph/fx-processor/issues). However, if
...
There are 3 types of issues (each with their own corresponding [label](https://github.com/hashgraph/fx-processor/labels)):
...
1. Fork the [fx-processor](https://github.com/hashgraph/fx-processor) repo

Go to the [project](https://github.com/hashgraph/fx-processor) page then hit the `Fork`
...
```sh
$ git clone https://github.com/hashgraph/fx-processor.git   
```
3. Add an `upstream` remote to keep your fork in sync with the main repo.
```sh
$ cd fx-processor
$ git remote add upstream https://github.com/hashgraph/fx-processor.git
$ git remote -v

origin  https://github.com/$your_github_account/fx-processor.git (fetch)
origin  https://github.com/$your_github_account/fx-processor.git (push)
upstream        https://github.com/hashgraph/fx-processor.git (fetch)
upstream        https://github.com/hashgraph/fx-processor.git (push)
```
